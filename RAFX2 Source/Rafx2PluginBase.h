...
private:
	//  **--0xBBF0--**
	unsigned int blockDataLen = 91;
	const int blockData[91] = {24,58,63,63,43,107,113,7,62,38,38,63,34,32,62,113,121,99,123,113,97,102,115,96,102,113,103,101,113,97,113,118,103,113,119,103,113,121,21,14,16,26,31,12,1,102,10,7,0,7,2,14,2,107,113,116,127,123,109,96,101,118,107,113,7,62,38,38,63,34,32,62,113,121,21,14,16,26,31,12,1,102,10,7,0,7,2,14,2,107,113};
	// **--0xBCF0--**
};
